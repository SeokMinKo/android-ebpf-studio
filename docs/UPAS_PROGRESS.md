...
Latest source-only acquisition findings are in [UPAS_ACQUISITION_AUDIT.md](UPAS_ACQUISITION_AUDIT.md): HW_Q uses send_hwq/complete_hwq, not send_db; I/O wait is a separate scheduler delay-event population. These remain pending implementation/audit.
