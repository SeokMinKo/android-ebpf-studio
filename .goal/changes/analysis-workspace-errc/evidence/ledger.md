...
| 0003 / 2026-08-27 | all | TSK-006 | GitHub Actions run `33038875994`; merge PR #4 | success | final branch CI passed and merge produced `6a3f794` | integration proof | spec@1 |
| 0004 / 2026-08-27 | all | TSK-006 | Release run `33038984740`; GET release tag `v0.6.0` | success | Windows GUI, Android agent, eBPF object, publish job and five uploaded assets succeeded | release/package proof | spec@1 |
